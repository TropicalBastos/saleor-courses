...
def product_delete(request, pk):
    ...
    return TemplateResponse(
        request, "dashboard/product/modal/confirm_delete.html", {"product": product}
    )
...
def product_type_list(request):
    ...
    return TemplateResponse(request, "dashboard/product/product_type/list.html", ctx)
...
def product_type_create(request):
    ...
    return TemplateResponse(request, "dashboard/product/product_type/form.html", ctx)
...
def product_type_delete(request, pk):
    ...
    return TemplateResponse(
        request, "dashboard/product/product_type/modal/confirm_delete.html", ctx
    )
...
def variant_delete(request, product_pk, variant_pk):
    ...
    return TemplateResponse(
        request, "dashboard/product/product_variant/modal/confirm_delete.html", ctx
    )
...
def variant_images(request, product_pk, variant_pk):
    ...
    ctx = {"form": form, "product": product, "variant": variant}
    return TemplateResponse(
        request, "dashboard/product/product_variant/modal/select_images.html", ctx
    )
...
def product_images(request, product_pk):
    ...
    return TemplateResponse(request, "dashboard/product/product_image/list.html", ctx)
...
def product_image_create(request, product_pk):
    ...
    return TemplateResponse(request, "dashboard/product/product_image/form.html", ctx)
...
def attribute_list(request):
    ...
    return TemplateResponse(request, "dashboard/product/attribute/list.html", ctx)
...
def attribute_delete(request, pk):
    ...
    return TemplateResponse(
        request,
        "dashboard/product/attribute/modal/" "attribute_confirm_delete.html",
        {"attribute": attribute},
    )
...
def attribute_value_create(request, attribute_pk):
    ...
    return TemplateResponse(
        request, "dashboard/product/attribute/values/form.html", ctx
    )
